...
namespace MVC.Data
{
    public static class DbInitializer
    {
        public static void Initialize(DBModel context)
        {
            ...
            {
                new Reservation{Room = rooms[0], Date = new DateTime(1974, 5, 12), CustomersName = "Toby", CustomersLastName = "Kabbell", CustomersEmail = "tkabbell@mail.com", CustomersPhone = "+420777111888", CustomersNote = "Would not be easy but clan of Frostwolves never gives up..."},
                new Reservation{Room = rooms[0], Date = new DateTime(1989, 2, 9), CustomersName = "Daniel", CustomersLastName = "Wu", CustomersEmail = "dwu@mail.com", CustomersPhone = "+420767333444", CustomersNote = "I will use the power of others."},
                new Reservation{Room = rooms[2], Date = new DateTime(1980, 11, 9), CustomersName = "Travis", CustomersLastName = "Fimmel", CustomersEmail = "tfimmel@mail.com", CustomersPhone = "+420681245917", CustomersNote = "This titan does not stand a chance."},
                new Reservation{Room = rooms[2], Date = new DateTime(1993, 3, 12), CustomersName = "Clancy", CustomersLastName = "Brown", CustomersEmail = "cbrown@mail.com", CustomersPhone = "+420721432771", CustomersNote = "I will not yeld."},
                new Reservation{Room = rooms[2], Date = new DateTime(1987, 9, 30), CustomersName = "Ben", CustomersLastName = "Shnetzer", CustomersEmail = "bschnetzer@mail.com", CustomersPhone = "+420724838551", CustomersNote = "Even tho I failed once, my next quest will not be such a disapointment."},
                new Reservation{Room = rooms[3], Date = new DateTime(1971, 5, 19), CustomersName = "Paula", CustomersLastName = "Patton", CustomersEmail = "ppatton@mail.com", CustomersPhone = "+420673193502", CustomersNote = "Will use every ace in my sleeve."}
            };
