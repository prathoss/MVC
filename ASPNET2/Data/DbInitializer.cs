    ...
    public static class DbInitializer
    {
        public static void Initialize(DBModel context)
        {
            ...
            Reservation[] reservations = new Reservation[]
            {
                ...
                new Reservation{Room = rooms[0], Date = new DateTime(2018, 5, 12, 13, 0, 0), CustomersName = "Toby", CustomersLastName = "Kabbell", CustomersEmail = "tkabbell@mail.com", CustomersPhone = "+420777111888", CustomersNote = "Would not be easy but clan of Frostwolves never gives up..."},
                new Reservation{Room = rooms[0], Date = new DateTime(2018, 5, 12, 14, 0, 0), CustomersName = "Toby", CustomersLastName = "Kabbell", CustomersEmail = "tkabbell@mail.com", CustomersPhone = "+420777111888", CustomersNote = "Would not be easy but clan of Frostwolves never gives up..."},
                new Reservation{Room = rooms[0], Date = new DateTime(2018, 5, 12, 16, 0, 0), CustomersName = "Toby", CustomersLastName = "Kabbell", CustomersEmail = "tkabbell@mail.com", CustomersPhone = "+420777111888", CustomersNote = "Would not be easy but clan of Frostwolves never gives up..."},
                new Reservation{Room = rooms[0], Date = new DateTime(2018, 5, 12, 19, 0, 0), CustomersName = "Toby", CustomersLastName = "Kabbell", CustomersEmail = "tkabbell@mail.com", CustomersPhone = "+420777111888", CustomersNote = "Would not be easy but clan of Frostwolves never gives up..."}
            };
